import { Post } from "@/db/queries/feed"
            ...
            <div className="cont_principal my-28">
                <div className="cont_central">
                    <div className="flex cont_modal cont_modal_active">
                        <div className="cont_photo cont_img_back" style={{ background: "#eee", backgroundImage: 'url(`${post?.url}`)', backgroundSize: "cover" }}>
                                ...
                                <div>
                                    <div className="cont_text_det_preparation recipeInfo">
                                        ...
                                        <div className="contDownload">
                                            <Download id={post?.id ?? 0} key={post?.file ?? ""}></Download>
                                        </div>
                                    </div>
